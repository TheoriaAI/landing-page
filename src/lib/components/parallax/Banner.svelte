	...
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		<div class="mx-auto max-w-2xl lg:mx-0">
			...
			<p class="mt-6 text-lg leading-8 text-gray-300">
				Welcome to Theoria AI, where we specialize in AI consulting solutions to drive innovation
				and efficiency. Let us transform your business with cutting-edge AI technologies.
			</p>
		</div>
